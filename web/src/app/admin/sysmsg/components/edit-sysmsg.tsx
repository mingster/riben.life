...
import { updateSystemMessageAction } from "@/actions/admin/systemMessage/update-system-message";
import {
	type UpdateSystemMessageInput,
	updateSystemMessageSchema,
} from "@/actions/admin/systemMessage/update-system-message.validation";
