...
const rsvpSettingsTabSchema = updateRsvpSettingsSchema.omit({
...
export const RsvpSettingTab: React.FC<RsvpSettingTabProps> = ({
	...
	const form = useForm<FormValues>({
		resolver: zodResolver(rsvpSettingsTabSchema) as Resolver<FormValues>,
		defaultValues,
		mode: "onChange",
 ...
 */}
							...
							<div className="space-y-4">
								...
								<p className="text-sm text-muted-foreground">
									{t("rsvp_reminder_channels_use_store_notification") ||
										"Reminder channels (email, LINE, SMS, etc.) are configured in Store Notification settings."}
								</p>
							</div>
									...
									{Object.entries(form.formState.errors).map(
										([field, error]) => {
											...
											const fieldLabels: Record<string, string> = {
												...
												reminderHours:
													t("RSVP_Reminder_Hours") || "Reminder Hours",
												syncWithGoogle:
