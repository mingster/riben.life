...
import { deleteFacilityPricingRuleAction } from "@/actions/storeAdmin/facility-pricing/delete-facility-pricing-rule";
...
interface CellActionProps {
	data: FacilityPricingRuleColumn;
