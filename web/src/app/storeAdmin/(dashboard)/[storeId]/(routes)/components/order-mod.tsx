...
import type { ProductOptionSelections, StoreTables } from "@prisma/client";
        ...
        <DialogContent>
          <div className="flex h-full flex-col">
            ...
            <div className="flex-1 overflow-auto p-4">
              <div className="pb-5">
                {store.StoreShippingMethods.map((method) => (
                  <div key={method.id}>{method.ShippingMethod.name}</div>
                ))}
