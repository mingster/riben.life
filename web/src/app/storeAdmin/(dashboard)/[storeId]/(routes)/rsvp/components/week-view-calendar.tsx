...
export const WeekViewCalendar: React.FC<WeekViewCalendarProps> = ({
	...
	// Calendar week Sunday → Saturday (store timezone semantics via getDateInTz dates)
	const weekStart = useMemo(
		() => startOfWeek(currentDayInStoreTz, { weekStartsOn: 0 }),
		[currentDayInStoreTz],
	);
	const weekEnd = useMemo(
		() => endOfWeek(currentDayInStoreTz, { weekStartsOn: 0 }),
		[currentDayInStoreTz],
	);
	...
	const handleNextWeek = useCallback(() => {
		setCurrentDay((prev) => addDays(prev, 7));
	}, []);
