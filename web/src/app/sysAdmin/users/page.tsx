...
import { UsersClient, type UserListItem } from "./components/client-user";
...
export default async function UsersAdminPage(props: {
	...
	const usersWithStats: UserListItem[] = users.map((user) => {
		...
		const { Orders: _o, Reservations: _r, CustomerCredit: _c, ...rest } = user;
		return {
			...rest,
