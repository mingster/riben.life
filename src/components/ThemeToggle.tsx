    ...
    <div className={className}>
      ...
      >
        <input
          ...
          className="dur absolute top-0 z-50 m-0 h-full w-full cursor-pointer opacity-0 bg-red"
        />
        <span
          className={`absolute left-[3px] top-1/2 flex h-6 w-6 -translate-y-1/2 translate-x-0 items-center justify-center rounded-full
